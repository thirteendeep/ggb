...
<section class="section__realisations">
    <div gr-grid="row">
        <div gr-grid="column">
...
<div class="background__accreditations">
    <section class="section__accreditations">
        <div gr-grid="row">
            <div gr-grid="column">
                <a name="accreditations"></a>
                <h1 class="site-section-title">
                    Nos accréditations
                </h1>
...
<div class="background__ecrivez-nous">
    <section class="section__ecrivez-nous">
        <div gr-grid="row">
            <div gr-grid="sm-5">
