...
<main class="gui-main">
    <div class="site-container">
        ...
        <section class="section-fluid__homepage-banner">
            <div class="homepage-banner__content">
                <h1 class="site-title--underline site-title--heavy">
                    LEADER IN DOWNDRAFT SOLUTIONS
                </h1>
                <div class="typography">
                    ...
                    <div class="button-container">
                        <a href="#" class="btn--primary btn--small">Discover our products</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="background__banner-application">
            <div class="section-fluid__banner-application">
                <div gr-grid="row">
                    <div class="banner-application__content" gr-grid="column md-offset-4 lg-offset-6">
