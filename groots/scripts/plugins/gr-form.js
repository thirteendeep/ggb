...
( function( $, window, document ) {
    ...
    $.extend( Plugin.prototype, {
        init: function() {
            ...
            $(this.element).next().andSelf().wrapAll('<div class="radio-wrapper"></div>');
        },
        destroy: function() {
            $(this.element).unwrap();
        }
...
( function( $, window, document ) {
    ...
    $.extend( Plugin.prototype, {
        init: function() {
            ...
            $(this.element).next().andSelf().wrapAll('<div class="checkbox-wrapper"></div>');
        },
        destroy: function() {
            $(this.element).unwrap();
        }
    ...
    $(document).on('ready domloaded ajaxloaded', function () {
        ...
        setInterval(function(){
            $(document).find('.gfield_checkbox input[type=checkbox]').customCheckbox();
        },500);
    });
...
( function( $, window, document ) {
    ...
    $.extend( Plugin.prototype, {
        init: function() {
            ...
            $(this.element).next().andSelf().wrapAll('<div class="file-upload-wrapper"></div>');
        },
        update: function() {
            if($(this.element).val()!=='') {
...
//     window.$ = $;
//     window.Parsley = require('parsleyjs/dist/parsley.min.js');
//     console.log(Parsley)
//     Parsley.$ = $;

//     //require('parsleyjs/src/i18n/fr.js');
//     //require('parsleyjs');
